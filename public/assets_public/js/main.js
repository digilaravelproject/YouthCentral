...
(function(){
  ...
  $(function(){
    ...
    // Use event delegation for listing item hover animations to work with dynamically loaded content
    $(document).on("mouseenter", ".listing-item-link", function(){
        var _ = $(this);
    ...
    $(document).on("mouseleave", ".listing-item-link", function(){
        var _ = $(this);
        if(_.parent().parent().parent().hasClass("grid2") || _.parent().parent().parent().hasClass("grid3")){
