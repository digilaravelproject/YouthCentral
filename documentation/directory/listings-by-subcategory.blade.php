      ...
      <div class="container-fluid listing-block">
        <div class="row listing white">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="assets/images/listings/2.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                   Best fried chicken of the town
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="#" class="category-icon icon-dinner"></a>
              <div class="listing-item-rating">4.6</div>
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Shuckers
                    <div class="ribbon">Special Menu for Kids</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/3.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                  1819 79th Street Causeway, Miami, FL
                </a>
                <div class="listing-item-excerpt">
                  Grill Best Affordable Waterfront Dining
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
            ...
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    St Roch Market
                    <div class="ribbon">Starts from $29</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/4.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                  2381 Saint Claude Ave, New Orleans, LA
                </a>
                <div class="listing-item-excerpt">
                  Breakfast to dinner, affordable price point
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="#" class="category-icon icon-dinner"></a>
              <div class="listing-item-rating">4.1</div>
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Mission Chinese Food
                    <div class="ribbon">Promotional Lunch $45</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/5.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                  Two generous family-style set menus
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="#" class="category-icon icon-dinner"></a>
              <div class="listing-item-rating">3.6</div>
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Pollo Chapin
                    <div class="ribbon">Open from 09:00 - Midnight</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/6.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                  2054 Junction, Detroit, MI
                </a>
                <div class="listing-item-excerpt">
                  Graceful service and cuisine that tastes delicious
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
            ...
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Citizen Pie
                    <div class="ribbon">Special Vegan Menu</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/7.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                  15710 Waterloo Rd, Cleveland, OH
                </a>
                <div class="listing-item-excerpt">
                  Gumbo, oysters, sazeracs, and some surprises
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
            ...
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    El Tamarindo
                    <div class="ribbon">Exclusive Breakfast $69</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/8.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                  1785 Florida Ave NW, Washington
                </a>
                <div class="listing-item-excerpt">
                  Serving the Adams Morgan neighborhood since 1982
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
            ...
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Bistro du Midi
                    <div class="ribbon">Fixed Price $99</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/9.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                  Provençal bistro to dazzle out-of-towners
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
            ...
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Hopleaf Bar
                    <div class="ribbon">Average Price: $25</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/10.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                  The interesting takes on Belgian food
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="#" class="category-icon icon-dinner"></a>
              <div class="listing-item-rating">5.0</div>
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Wynwood Kitchen
                ...
                <img alt="" src="assets/images/listings/11.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                  Genuinely delicious dishes, expertly prepared
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="#" class="category-icon icon-dinner"></a>
              <div class="listing-item-rating">4.8</div>
              <a href="#" class="listing-item-link">
                <div class="listing-item-title-centralizer">
                  <div class="listing-item-title">
                    Galatoires
                    <div class="ribbon">Traveller Meal $69</div>
                  </div>
                </div>
                <img alt="" src="assets/images/listings/12.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
                ...
                <div class="listing-item-excerpt">
                  Jackets-required grand dame of Bourbon Street
                </div>
              </div>
              <div class="listing-category-name">
                <a href="#">Restaurant</a>
