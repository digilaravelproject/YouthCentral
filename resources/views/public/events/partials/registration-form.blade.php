<form action="{{ route('events.register.process', $event) }}" method="POST" id="event-registration-form">
    @csrf
            ...
            <div class="card-body">
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="parent_consent" style="font-size:12px;">
                        I am the parent/guardian of the student registering for YC SPARK 2025. I give my consent for their participation in this online event and agree that Youth Central may collect and securely use the required student information for registration and event communication.
                    </label>
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label" for="terms_conditions" style="font-size:12px;">
                        ...
                        I have read and understood the <a href="{{ route('events.parent-guardian-consent') }}" target="_blank">Terms & Conditions of YC SPARK 2025</a> and agree on behalf of the student.
                    </label>
