...
<html lang="en-US">
  <head>
    ...
    <title>Youth Central - Reset Password</title>
    <!-- Google Font(s) -->
    ...
    <div class="body-wrapper">
      ...
      <header class="header">
        ...
        <div class="user-buttons">
          <a href="{{ route('user.login') }}" class="add-listing">Back to Login</a>
        </div>
        <!-- End User Buttons -->
      </header>
      <!-- End header (topbar) -->
              ...
              <p>Please create a new password for your account.</p>
                ...
                <form action="/reset-password" method="POST" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" name="email" type="email" class="form-control" placeholder="your@email.com" value="{{ request()->email ?? old('email') }}" required>
                    @error('email')
                  ...
                  <div class="form-group">
                    ...
                    <input id="password-confirmation" name="password_confirmation" type="password" class="form-control" placeholder="Confirm Password" required>
                  </div>
                  <div class="form-group">
                    <button type="submit" class="form-control btn btn-submit">Reset Password</button>
                  </div>
                </form>
                
                <div class="login-links">
                  <a href="{{ route('user.login') }}">Return to Login</a>
                </div>
    					</div>
    				</div>
    			</div>
