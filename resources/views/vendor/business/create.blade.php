    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('vendor.businesses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('business_name') is-invalid @enderror" type="text" id="business_name" name="business_name" value="{{ old('business_name') }}" required>
                                    @error('business_name')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('whatsapp_number') is-invalid @enderror" type="text" id="whatsapp_number" name="whatsapp_number" value="{{ old('whatsapp_number') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('website') is-invalid @enderror" type="url" id="website" name="website" value="{{ old('website') }}">
                                    @error('website')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('facebook_link') is-invalid @enderror" type="url" id="facebook_link" name="facebook_link" value="{{ old('facebook_link') }}">
                                    @error('facebook_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('instagram_link') is-invalid @enderror" type="url" id="instagram_link" name="instagram_link" value="{{ old('instagram_link') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('twitter_link') is-invalid @enderror" type="url" id="twitter_link" name="twitter_link" value="{{ old('twitter_link') }}">
                                    @error('twitter_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('pinterest_link') is-invalid @enderror" type="url" id="pinterest_link" name="pinterest_link" value="{{ old('pinterest_link') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <input type="time" class="form-control me-2 @error('business_hours.'.$day.'.opening_time') is-invalid @enderror" name="business_hours[{{ $day }}][opening_time]" value="{{ old('business_hours.'.$day.'.opening_time', '09:30') }}">
                                            <span class="mx-2">to</span>
                                            <input type="time" class="form-control me-2 @error('business_hours.'.$day.'.closing_time') is-invalid @enderror" name="business_hours[{{ $day }}][closing_time]" value="{{ old('business_hours.'.$day.'.closing_time', '18:30') }}">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="business_hours[{{ $day }}][is_closed]" value="1" id="{{ $day }}_closed" {{ old('business_hours.'.$day.'.is_closed') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="{{ $day }}_closed">Closed</label>
                                            </div>
                                        </div>
                                        @error('business_hours.'.$day.'.opening_time') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                        @error('business_hours.'.$day.'.closing_time') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a href="{{ route('vendor.businesses.index') }}" class="btn btn-secondary me-2">Cancel</a>
