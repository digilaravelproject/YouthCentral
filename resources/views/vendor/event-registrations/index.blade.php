        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pt-3 pb-2">
                    <form action="{{ route('vendor.event-registrations.get_registrations') }}" method="GET" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                    ...
                    @endif
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('vendor.event-registrations.show', $registration->id) }}" class="btn btn-link text-info text-gradient px-3 mb-0">
                                            <i class="fas fa-eye me-2"></i>View
                                        </a>
                                        @if($registration->payment_status === 'paid')
                                        <a href="{{ route('vendor.event-registrations.receipt.download', $registration->id) }}" class="btn btn-link text-dark px-3 mb-0">
