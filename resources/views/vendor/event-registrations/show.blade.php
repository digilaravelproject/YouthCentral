            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('vendor.event-registrations.get_registrations') }}" class="btn btn-sm btn-primary">Back to List</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        @if($registration->payment_status === 'paid')
                        <a href="{{ route('vendor.event-registrations.receipt.download', $registration->id) }}" class="btn btn-sm btn-success">
