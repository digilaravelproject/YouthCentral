        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Add Model Question Paper</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.model-question-papers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" required onchange="toggleInputs()">
                                        ...
                                        <?php /*<option value="STEM" {{ old('type') == 'STEM' ? 'selected' : '' }}>STEM Resources (YouTube Video)</option>  */ ?>
                                    </select>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-gradient-primary m-0">Save Paper</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    document.getElementById('select-all').addEventListener('change', function() {
        ...
        checkboxes.forEach(cb => {
            ...
            if (this.checked) {
                selectedStudents[id] = { id, label, grade };
            } else {
    ...
    // seed assigned students if provided by server
