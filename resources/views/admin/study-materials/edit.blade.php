        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Edit Study Material</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.study-materials.update', $studyMaterial->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="title" name="title" required value="{{ old('title', $studyMaterial->title) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" required onchange="toggleInputs()">
                                        <option value="PDF" {{ old('type', $studyMaterial->type) == 'PDF' ? 'selected' : '' }}>PDF</option>
                                        <option value="Worksheet" {{ old('type', $studyMaterial->type) == 'Worksheet' ? 'selected' : '' }}>Worksheet</option>
                                        <option value="STEM" {{ old('type', $studyMaterial->type) == 'STEM' ? 'selected' : '' }}>STEM Resources (YouTube Video)</option>
                                    </select>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="subject" name="subject" value="{{ old('subject', $studyMaterial->subject) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="month" id="month" name="month" value="{{ old('month', $studyMaterial->month ? \Carbon\Carbon::parse($studyMaterial->month)->format('Y-m') : '') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="topic" name="topic" value="{{ old('topic', $studyMaterial->topic) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @if($studyMaterial->file_path)
                                        <p class="text-xs mt-2">Current file: <a href="{{ asset('storage/' . $studyMaterial->file_path) }}" target="_blank">View</a></p>
                                    @endif
                        ...
                        <div class="row d-none" id="video-input-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="url" id="video_link" name="video_link" value="{{ old('video_link', $studyMaterial->video_link) }}">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn bg-gradient-primary m-0">Update Material</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    // If a single class is detected from assigned students, auto-load
    if (selectedClass) {
        document.getElementById('student_class').value = selectedClass;
        loadStudents();
    }
