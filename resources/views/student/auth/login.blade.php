...
<html lang="en-US">
  <head>
    ...
    <title>Youth Central - Student Login</title>
    <!-- Google Font(s) -->
      ...
      <div class="container">
      	<div class="row">
                ...
                <a href="#" class="active" id="login-form-link">Student Login</a>
                  ...
                  @endif
    								<form id="login-form" action="{{ route('student.send-otp') }}" method="post">
                    @csrf
    									<div class="form-group">
    										<input type="text" name="phone" id="phone" tabindex="1" class="form-control @error('phone') is-invalid @enderror" placeholder="Mobile Number (Used for Registration)" value="{{ old('phone') }}" required>
                      @error('phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
    									</div>
    									<div class="form-group">
    										<input type="submit" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-submit" value="Send OTP">
    									</div>
    									<div class="form-group">
    										<div class="row">
    											<div class="col-lg-12">
