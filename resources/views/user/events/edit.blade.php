...
@section('title', 'Edit My Event: ' . $event->title)
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">Edit My General Event: <span class="text-info">{{ $event->title }}</span></h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.my-events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-sm bg-gradient-primary">Update My Event</button>
                        </div>
                    </form>
                </div>
            </div>
