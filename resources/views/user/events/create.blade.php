        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">Create My General Event</h6>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('user.my-events.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="mt-4 d-flex justify-content-end">
                             <a href="{{ route('user.my-events.index') }}" class="btn btn-sm bg-gradient-secondary me-2">Cancel</a>
                            <button type="submit" class="btn btn-sm bg-gradient-primary">Create My Event</button>
                        </div>
                    </form>
                </div>
            </div>
