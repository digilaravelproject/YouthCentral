            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h6>Subcategories</h6>
                        <a href="{{ route('admin.subcategories.create') }}" class="btn btn-primary btn-sm">Add New</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($subcategory->image)
                                            <img src="{{ asset($subcategory->image) }}" alt="{{ $subcategory->name }}" class="avatar avatar-sm rounded-circle me-2">
                                        @else
                                    ...
                                    <td class="align-middle text-center">
                                        @if($subcategory->icon_class)
                                            <i class="fas fa-{{ $subcategory->icon_class }} text-primary" style="font-size: 1.2rem;" title="{{ $subcategory->icon_class }}"></i>
                                        @else
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('admin.subcategories.edit', $subcategory) }}" class="text-secondary font-weight-bold text-xs me-3" data-toggle="tooltip" data-original-title="Edit subcategory">
                                            Edit
                                        </a>
